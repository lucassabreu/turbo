...
class FrameTests extends TurboDriveTestCase {
    ...
    async "test navigating a eager frame with a link[method=get] that does not fetch eager frame twice"() {
        ...
        await this.nextBeat;
        const eventLogs = await this.eventLogChannel.read();
        const fetchLogs = eventLogs.filter(([name, options]) => { var _a; return name == "turbo:before-fetch-request" && ((_a = options === null || options === void 0 ? void 0 : options.url) === null || _a === void 0 ? void 0 : _a.includes('/src/tests/fixtures/frames/frame_for_eager.html')); });
        this.assert.equal(fetchLogs.length, 1);
        const src = (_a = await this.attributeForSelector("#eager-loaded-frame", "src")) !== null && _a !== void 0 ? _a : "";
